...
class TestEdit(TestCase):
    ...
    def test__edit__add_month(self):
        o = Diti("2023-01-01")
        o.edit().add(DitiPart.MONTHS, 1).commit()
    ...
    def test__edit__add_day(self):
        o = Diti("2023-01-01")
        o.edit().add(DitiPart.DAYS, 1).commit()
    ...
    def test__edit__add_hour(self):
        o = Diti("2023-01-01")
        o.edit().add(DitiPart.HOURS, 1).commit()
    ...
    def test__edit__add_minute(self):
        o = Diti("2023-01-01")
        o.edit().add(DitiPart.MINUTES, 1).commit()
    ...
    def test__edit__add_second(self):
        o = Diti("2023-01-01")
        o.edit().add(DitiPart.SECONDS, 1).commit()
    ...
    def test__edit__add_microsecond(self):
        o = Diti("2023-01-01")
        o.edit().add(DitiPart.MICROSECONDS, 1).commit()
